$("document").ready(function(){
    ...
    $("#covid").hide();
    $("body").append(`<div id="covidModal"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"></div><div class="modal-body"></div><div class="modal-footer"></div></div></div></div>`);
    ...
    $("#covidModal>div>div>.modal-body").append(`<ul><li>We are limiting customer numbers in store, and may ask you to wait outside.</li><li>Hand sanitiser is available for staff and customers.</li><li>No need to book an appointment.</li><li>Surfaces and touch points disinfected regularly.</li><li>Our staff will be wearing masks in store.</li></ul>`);
