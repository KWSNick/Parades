$("document").ready(function() {
    ...
    $("#tagline h1, #headerContact h1").addClass("d-block mainFont taglinePadding");
    ...
    $(".navbar-nav").addClass("col noPadding mainFont ml-auto");
    ...
    $("#intro").addClass("col-12 font1 mainFont noPadding");
